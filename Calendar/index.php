...
//Triggered if new entry button is clicked. Clear all calendar variables in the session to ensure fresh variables on the new entry page.
...
//Get the number of days for the specified month, defaults to current +- based on arrow buttons
...
//I'm sorry for everything :( - calendar header
echo "<center>";
echo "<table>";
