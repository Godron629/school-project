...
<head>
	...
	<!-- Default Stylesheet -->
	<link rel="stylesheet" type="text/css" href="/Calendar/Volunteer/css/stylesheet.css">
	...
	<!-- Default Scripts -->
	<script src="/Calendar/Volunteer/javascript/loadVolunteer.js"></script>
	<script src="/Calendar/Volunteer/javascript/updateVolunteer.js"></script>
	<script src="/Calendar/Volunteer/javascript/deleteVolunteer.js"></script>
	</script>
</head>
<body class="wrapper">

	<h1><img id="logo" src="images/logo.gif"><a href="/Calendar/Volunteer/index2.php">Update Volunteer</a></h1>
	<div id="topRightNav">
		<a href="/Calendar/TimeClock/index.php">Time Clock</a>
		<a href="#">Logout</a>
	</div>
	...
	<div id="mainNav">
		<ul>
			...
			<li><a href="/Calendar/Reports/reports.php">Reports</a></li>
		</ul>
	</div>

	<div class="container main">
		<div class="selectVolunteerForm">
			<form action="/Calendar/Volunteer/php/updateVolunteer.php">
				<!-- Select2 Select -->
				<select class="selectVolunteer" size="3">
					<option value="" disabled selected>Select Volunteer...</option>
					<?php include $_SERVER['DOCUMENT_ROOT'] . "/Calendar/Volunteer/php/databasePHPFunctions.php";
		...
		<div class="container bigButtons" id="submitButtons">
			...
			<a href="/Calendar/Volunteer/index2.php"><button type="button">Cancel</button></a>
