...
<!DOCTYPE html> <!-- Gideon Richter 2/22/2017, Jeff Emshey 3/21/2017 -->
<html>
<head>
...
<body class="wrapper">
	...
	<h1><a href="/Foodbank/Admin/home.php"><img id="logo" src="/Foodbank/images/logo.gif"></a><a href="/Foodbank/Volunteer/updateVolunteer.php">Update Volunteer</h1></a>
	<div id="topRightNav">
		...
		<div class="selectVolunteerForm">
			<form action="updateVolunteer.php">
				...
				<select class="selectVolunteer" size="3">
					...
					<?php include $_SERVER['DOCUMENT_ROOT'] . "/Foodbank/code/php/databaseFunctions.php";
