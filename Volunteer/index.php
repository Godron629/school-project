...
<head>
	...
	<!-- Default Scripts -->
	<script src="/Calendar/Volunteer/javascript/newVolunteer.js"></script>
</head>
<body class="wrapper">

	<h1><img id="logo" src="images/logo.gif"><a href="/Calendar/Volunteer/index.php">New Volunteer</a></h1>
	<div id="topRightNav">
	...
	<div class="container main">
		<div class="container leftSide blockLabels marginBottomTextBox" id="volunteerInformation">
			...
			<form action="/Calendar/Volunteer/php/createNewVolunteer.php" id="volunteerForm" method="POST">
